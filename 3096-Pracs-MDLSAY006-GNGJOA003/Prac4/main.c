...
uint32_t prev_millis = 0; // Variables for debouncing
...
void EXTI0_1_IRQHandler(void)
{
	...
	{
		if (curr_millis - prev_millis >= 250) // Checked to see if enough time has passed since the previous time the button was clicked
			{
